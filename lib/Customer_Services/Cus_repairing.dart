...
class Repairing extends StatefulWidget {
  ...
  @override
  State<Repairing> createState() => _RepairState();
}

class _RepairState extends State<Repairing> {
  ...
  String dropdownvalue = 'Flat Tire';
  var items = [
    "Flat Tire",
    "Jump Start Battery",
    "Locked Car",
  ...
  Widget build(BuildContext context) {
    ...
    final RepairDescription = SizedBox(
      // width: size.width,
          ...
          onPressed: () {
            Navigator.pushAndRemoveUntil(
                ...
                MaterialPageRoute(builder: (context) => PickMap(
                  carModel: carModelEditingController.text,
                  carPlateNo: carPlateNoEditingController.text,
