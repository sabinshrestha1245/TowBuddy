...
class MapSampleState extends State<DropMap> {
  ...
  Widget build(BuildContext context) {
    ...
    if (appData.pinnedDropOffLocationOnMap != null) {
      originAddress =
          appData.pinnedDropOffLocationOnMap!.dropOffPlaceName.toString();
    } else {
                      ...
                      TextButton(
                        onPressed: () {
                          ...
                          Navigator.pushAndRemoveUntil(
                              (context),
                              MaterialPageRoute(
                                  builder: (context) => Billing(carModel: '', carPlateNo: '', remarks: '', pickUpLocation: '', dropOffLocation: '',)),
                                  (route) => true);
                        },
                        child: const Text(
                          "Continue",
  ...
  postDataToFirebase() async {
    var firebaseFirestore = await FirebaseFirestore.instance
